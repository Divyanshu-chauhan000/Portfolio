...
const About = () => {
  return (
    ...
    >
      ...
      <div className="absolute -top-32 -left-32 w-96 h-96 bg-blue-500/30 rounded-full blur-[120px]"></div>
      ...
      <div className="relative max-w-6xl mx-auto px-6">
         <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-200 mb-6 leading-tight">
            ...
            <div className="flex gap-4 ">
                   <a href="/resume.pdf" className="px-7 py-3 rounded-xl bg-[#0202617] border border-gray-800 text-gray-200 font-medium shadow-lg hover:shadow-cyan-500/20 hover:translate-y-1 hover:border-cyan-400 transition">Download Resume</a>
                   <a href="#projects" className="px-7 py-3 rounded-xl  border bg-gray-200  font-medium hover:bg-black hover:text-gray-200 transition">View Projects</a>
            </div>
          </div>
          {/* Right content -----> */}  
